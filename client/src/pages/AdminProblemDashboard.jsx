...
function AdminProblemDashboard() {
  ...
  const publishProblem = async (id) => {
    ...
    try {
      ...
      const res = await api.patch(`/api/v1/problems/${id}/publish`)
                    ...
                    >
                      ...
                      <td className="p-4">
                        <PublishToggle
                          ...
                          onToggle={() => publishProblem(problem._id)}
                        />
                      </td>
...
function PublishToggle({ isPublished, onToggle }) {
  return (
    <button
      type="button"
      onClick={onToggle}
      ...
      className={`
        ...
        ${isPublished ? "cursor-not-allowed opacity-80" : "cursor-pointer"}
      `}
    >
      {/* Toggle Circle */}
      <span
